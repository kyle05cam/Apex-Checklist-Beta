  ...
  switch (name) {
    ...
    case "engine":   return (
      <svg viewBox="0 0 24 24" {...s}>
        ...
        <path d="M17 10h3v4h-3M7 7v-2M11 7v-2M15 7v-2M7 17v2M11 17v2M15 17v2"/>
      </svg>
    );
    case "spin":     return (
      <svg viewBox="0 0 24 24" {...s}>
    ...
    case "mic-off":  return (
      <svg viewBox="0 0 24 24" {...s}>
        <path d="M2 2l20 20M9 9v2a3 3 0 0 0 5 2M15 9V6a3 3 0 0 0-5-2M5 11a7 7 0 0 0 11 5.4M12 18v3M9 21h6"/>
      </svg>
    );
    case "radar":    return (
      <svg viewBox="0 0 24 24" {...s}>
